...
public class CommunityQuality {
	public static void main(String[] args) {
		...
		// Commented out the network file parameter because we are running
		// only with ground truth
		String networkFile = "";
		// Commented out "hard wired" parameter files, make it accept command line arguments
		//String discoveredCommunityFile = "./test1";
		String discoveredCommunityFile = args[0];
		//String groundTruthCommunityFile = "./test2";
		// Commented out "hard wired" parameter files, make it accept command line arguments
		String groundTruthCommunityFile = args[1];
		...
		double[] qualities = CommunityQuality.computeInformationEntropyMetrics(
